        ...
        private void HumanoidEditorGUI()
        {
            ...
            #region Tools
            {
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    {
                        EditorGUI.BeginChangeCheck();
                        var flag = GUILayout.Toggle(va.collisionEnable, Language.GetContent(Language.Help.EditorOptionsCollision), va.collisionEnable ? vaw.guiStyleActiveMiniButton : EditorStyles.miniButton);
                        if (EditorGUI.EndChangeCheck())
                        {
